...
import { PKG_BRAND_NAME, PKG_CAMELCASE_LOCAL_NAME, PKG_CAMELCASE_NAME, epOutput, epRoot, localeRoot } from '../utils'
...
async function buildFullEntry(minify: boolean) {
	...
	console.log(path.resolve(epRoot, 'index.ts'), '入口文件====')
...
export const buildFull = (minify: boolean) => async () => {
	// 先不打包多语言相关的东西 buildFullLocale(minify)
